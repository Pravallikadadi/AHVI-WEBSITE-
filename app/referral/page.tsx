    ...
    <MarketingShell>
      <section className="relative overflow-hidden bg-ink text-bg">
        ...
        <div className="relative mx-auto max-w-[900px] px-5 py-16 text-center sm:px-8 sm:py-20">
          <div className="mb-4.5 text-[11px] tracking-[0.26em] text-goldsoft">AHVI referral</div>
          ...
          <p className="mx-auto max-w-[44ch] text-[15.5px] leading-relaxed text-bg/65">
            Invite the people whose style you love. When they join AHVI through your referral, you unlock more access
            for your wardrobe.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[900px] px-5 pt-10 sm:px-8">
        <div className="mb-4.5 text-center text-[10.5px] tracking-[0.22em] text-muted">Your AHVI circle</div>
        <ReferralDashboard />
      </section>
          ...
          <div className="grid gap-9 text-center" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 200px), 1fr))" }}>
            {referralSteps.map((s) => (
              <div key={s.n}>
                ...
                <div className="mb-1.5 font-condensed text-[17px] font-semibold">{s.title}</div>
                <div className="text-[12.5px] leading-relaxed text-bg/60">{s.body}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="border-y border-ink/10 bg-bg">
        <div className="mx-auto max-w-[1100px] px-5 py-16 sm:px-8 sm:py-24">
          <div className="mb-14 max-w-[640px]">
            <div className="mb-4 text-[11px] tracking-[0.26em] text-muted">Why AHVI?</div>
            ...
            <p className="max-w-[54ch] text-[15px] leading-relaxed text-muted">
              AHVI brings style, preparation and planning together in one intelligent experience — making everyday
              decisions feel simpler and more personal.
            </p>
          </div>

          <div className="grid gap-0 sm:grid-cols-3">
            {[
              { n: "01", label: "Style", title: "Know what to wear.", body: "Your wardrobe, AI Stylist, Style Boards and Daily Wear come together to make getting dressed feel effortless." },
              { n: "02", label: "Prep", title: "Be ready for what's next.", body: "From packing and skincare to events and routines, AHVI helps you prepare before the moment arrives." },
              { n: "03", label: "Plan", title: "Know what's coming.", body: "Bring your calendar, meals, workouts, bills and daily routines into one connected plan." },
            ].map((v) => (
              <div key={v.n} className="group border-t border-ink/15 py-7 pr-8 transition-transform duration-300 motion-safe:hover:-translate-y-1.5">
                <div className="mb-8 flex items-baseline justify-between">
                  <span className="font-condensed text-[14px] tracking-[0.06em] text-muted2">{v.n}</span>
                ...
                <p className="max-w-[32ch] text-[14.5px] leading-relaxed text-muted">{v.body}</p>
              </div>
            ))}
          </div>

          <div className="mt-20 text-center">
            <div className="mb-4 text-[11px] tracking-[0.26em] text-muted">Share AHVI</div>
            ...
            <p className="mx-auto mb-7 max-w-[46ch] text-[15px] leading-relaxed text-muted">
              Know someone who would love a more effortlessly put-together day? Share AHVI with them.
            </p>
